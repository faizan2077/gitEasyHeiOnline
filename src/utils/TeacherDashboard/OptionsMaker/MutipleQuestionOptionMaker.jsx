...
const MutipleQuestionOptionMaker = (props) => {
  // Props
  const {
...
headquestion
  ...
  headquestion
    ...
    const subQuestions={
      ...
      options:option,
      quesType:temp.subQuestions[0].quesType,
      _id:temp.subQuestions[0]._id,
      question:qtemp,
      solution:{
        // photo:
    ...
    temp.question=headquestion
    temp.subQuestions[0]=subQuestions


    setfullquestion(temp)
console.log("this is the full question we have to send to api",fullquestion)
updatequestion(fullquestion).then((data=>{
  const predata=[...questionbank]
  predata[index]=data

  console.log("the updated questions",predata)
...
export default MutipleQuestionOptionMaker;
