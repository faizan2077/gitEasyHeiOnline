  ...
  return (
   ...
   <div className="shiftend">
      <div className="textEditor__main">
        ...
        >
          {Parser().parse(inputvals)}
        </label>
      
        </div>
      {photo != "no pic" ? <div className="textEditor__main"> <div className="center image">{Parser().parse(photo)}</div></div> : ""}
