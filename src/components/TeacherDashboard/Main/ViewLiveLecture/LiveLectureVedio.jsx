...
const LiveLecturesVideo = ({getlecturesbyidfordata }) => {
  ...
  return (
   ...
   <div className="container" style={{"width": "42vw","height": "50vh"}}>
              ...
              <ReactPlayer config={{
                  ...
                  }} url={`https://www.youtube.com/watch?v=${singlelecture!=null?singlelecture.link:"8fJxQAbG8lI&t"}?autoplay=1&rel=0&showinfo=0&rel=0&modestbranding=1&controls=0 `} width={"100%"}  />
              </div>
                    </div>
...
export default connect(mapStateToProps, { getlecturesbyidfordata }) (LiveLecturesVideo);
